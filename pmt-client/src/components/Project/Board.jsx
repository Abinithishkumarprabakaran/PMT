...
import AddTaskModal from "../Supplements/AddTaskModal";
import BtnPrimary from '../Supplements/BtnPrimary'
// import DropdownMenu from "../Supplements/DropdownMenu";
// import TaskModal from "../Supplements/TaskModal";
import { useParams, useNavigate } from "react-router";
import ProjectDropDown from "../Supplements/ProjectDropDown"
          ...
          {Object.entries(columns).map(([columnId, column], index) => {
            return (
                ...
                >
                  ...
                  <div>
                    <DroppableCol column={column} columnId={columnId}/>
                  </div>
